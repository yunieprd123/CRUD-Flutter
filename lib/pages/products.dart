...
import 'package:plant_shop/models/product.dart';
import 'package:plant_shop/pages/addproduct.dart';
import 'package:plant_shop/services/databasehelper.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          backgroundColor: Color.fromARGB(255, 60, 155, 63),
